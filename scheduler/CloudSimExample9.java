 ...
 * cloudlet on it.
 */
public class CloudSimeExample9 {
	...
	try {
	   ...
	   // Vm vm = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm,
	    ...
	    WorkloadFileReader workloadFileReader = new WorkloadFileReader("/Users/harshitdokania/Desktop/cs525/geosched/workloads/google/5_1.csv", 1);
	...
	hostId++;
	hostList.add(new Host(hostId, new RamProvisionerSimple(ram), new BwProvisionerSimple(bw),
		    storage, peList2, new VmSchedulerTimeShared(peList))); // This is our
									  // machine

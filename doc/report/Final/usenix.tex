...
\begin{figure} %
    \centering
    \subfloat[CPU resource ]{{\includegraphics[width=8cm]{cpu} }}%
    \newline
    
    \subfloat[RAM resource]{{\includegraphics[width=8cm]{mem} }}%
...
\begin{figure*} %
    \centering
    \subfloat[Daily Average Temperature ]{{\includegraphics[width=8cm]{AverageTemp} }}%
    \subfloat[Daily Maximum Variation]{{\includegraphics[width=8cm]{Variation} }}%
